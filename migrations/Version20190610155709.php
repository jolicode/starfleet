...
final class Version20190610155709 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conference (id INT NOT NULL, remote_id VARCHAR(255) DEFAULT NULL, hash VARCHAR(255) DEFAULT NULL, source VARCHAR(20) NOT NULL, slug VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, location VARCHAR(255) NOT NULL, start_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, end_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, cfp_url VARCHAR(255) DEFAULT NULL, cfp_end_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, site_url VARCHAR(255) DEFAULT NULL, article_url TEXT DEFAULT NULL, attended BOOLEAN DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
